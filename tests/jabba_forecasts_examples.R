...
# 
# jbplot_ensemble(fw.io) # default
# 
# jbpar(mfrow=c(2,2)) # Individual
...
# 
# 
# # Ensemble (deterministic - no process error like in SS3) 
...
# jbplot_ensemble(fw.ioar1.det ,add=T,subplots = 6)
# 
# # ICCAT Style with absolute TACs
# TACs = seq(300,800,50)
# 
...
# 
# 
# # F-based forecasting relative to Fmsy for Base-Case model
...
# 
# # F-based forecasting relative to Fmsy with AR1 process error
...
# }
# 
# # Do hindcast cross-validation (takes as bit)
